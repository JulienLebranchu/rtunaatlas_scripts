...
######################################################################
# wps.des: id = southern_hemisphere_oceans_effort_1deg_1m_ll_tunaatlasccsbt_level0, title = Harmonize data structure of CCSBT Longline effort datasets, abstract = Harmonize the structure of CCSBT catch-and-effort datasets: 'Longline' (pid of output file = southern_hemisphere_oceans_effort_1deg_1m_ll_tunaatlasccsbt_level0). The only mandatory field is the first one. The metadata must be filled-in only if the dataset will be loaded in the Tuna atlas database. ;

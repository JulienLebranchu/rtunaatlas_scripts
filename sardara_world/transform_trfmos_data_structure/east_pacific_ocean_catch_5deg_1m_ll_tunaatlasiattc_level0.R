...
# wps.in: id = path_to_catch_dataset, type = String, title = Path to the catch dataset. Input file must be structured as follow: https://goo.gl/ObIRfj, value = "https://goo.gl/ObIRfj";
...
##Catches
catches<-read.csv(path_to_catch_dataset,stringsAsFactors = F)
efforts<-read.csv(path_to_effort_dataset,stringsAsFactors = F)

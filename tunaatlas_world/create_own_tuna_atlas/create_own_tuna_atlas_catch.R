...
# wps.in: id = unit_conversion_convert, type = boolean, title = Convert units of measure? if TRUE you must fill-in the parameter unit_conversion_df_conversion_factor. , value = FALSE;

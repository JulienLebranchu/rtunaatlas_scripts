...
if (raising_georef_to_nominal=="TRUE") {   
  ...
  if (fact=="catch"){
    ...
    georef_dataset<-function_raising_georef_to_nominal(fact,georef_dataset,dataset_to_compute_rf,nominal_catch,x_raising_dimensions,raising_do_not_raise_wcfpc_data)

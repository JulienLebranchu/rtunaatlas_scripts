...
metadata$description<-paste0(metadata$description,"- Data that were provided at resolutions superior to 1° x 1° were disaggregated to the corresponding 1° x 1°quadrants by dividing the catch equally on the overlappings 1° x 1° quadrants.\n")

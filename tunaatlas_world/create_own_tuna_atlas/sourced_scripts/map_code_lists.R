...
metadata$description<-paste0(metadata$description,"- Original codes were mapped with standard FAO code lists for gears (ISSCFG), species (ASFIS) and flags (ISO3 countries codes) in collaboration with the tRFMOs Secretariats.\n")
}

...
metadata$description<-paste0(metadata$description,"- Original code were mapped with standard FAO code lists (for gears, species, flags). These mappings were in collaboration with the RFMOs secretariats.\n")

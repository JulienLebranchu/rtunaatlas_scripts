...
metadata$description<-paste0(metadata$description,"- Data that were provided at resolutions superior to 5° x 5° were disaggregated to the corresponding 5° x 5°quadrants by dividing the catch equally on the overlappings 5° x 5° quadrants.\n")

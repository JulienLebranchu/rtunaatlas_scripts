...
path_to_table_parameterization_datasets<-"https://raw.githubusercontent.com/ptaconet/rtunaatlas_scripts/master/tunaatlas_world/metadata_and_parameterization_files/metadata_codelists_2017.csv"
...
for (df_to_load in 1:nrow(metadata_and_parameterization_dataset)){
  ...
  rm(list=setdiff(ls(), c("metadata_and_parameterization_dataset","df_to_load","con_admin","year_tuna_atlas")))
